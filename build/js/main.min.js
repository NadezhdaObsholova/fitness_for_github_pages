...
var _price = require("./modules/price");
var _initSwiper = require("./modules/swiper-jury/init-swiper");
var _initSwiper2 = require("./modules/swiper-reviews/init-swiper");
...
},{"./modules/form-validate/form":3,"./modules/price":9,"./modules/swiper-jury/init-swiper":10,"./modules/swiper-reviews/init-swiper":11,"./modules/video":12,"./utils/ios-vh-fix":14,"./vendor/accordion/init-accordion":16,"./vendor/tabs/init-tabs":18}],2:[function(require,module,exports){
"use strict";
...
var baseSuccessCallback = function baseSuccessCallback(event) {
  ...
  var formData = new FormData(document.querySelector('[data-form-node] form'));
...
exports.changePrices = void 0;
var priceOptions = document.querySelectorAll('[data-price-option]');
var prices = document.querySelectorAll('[data-price]');
var pricesShadow = document.querySelectorAll('[data-price-shadow]');
var lessonsCount = document.querySelector('[data-lessonsCount]');
var PRICES = [[5000, 1700, 2700], [30000, 10200, 16200], [60000, 20400, 32400]];

// количество занятий с тренером для разных периодов
var lessonsCountsOfOptions = ['12 занятий', '72 занятия', '144 занятия'];
var changePrices = exports.changePrices = function changePrices() {
  priceOptions[0].classList.add('is-active');
  priceOptions.forEach(function (button, index) {
    button.addEventListener('click', function () {
      lessonsCount.textContent = lessonsCountsOfOptions[index];
      prices.forEach(function (price, indexPrice) {
        price.textContent = PRICES[index][indexPrice];
      });
      pricesShadow.forEach(function (price, indexPrice) {
        price.textContent = PRICES[index][indexPrice];
      });
      priceOptions.forEach(function (btn) {
...
exports.swiperJury = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var swiper = document.querySelector('[data-swiper="jury-swiper"]');
var buttonNext = document.querySelector('[data-button="jury-button-next"]');
var buttonPrev = document.querySelector('[data-button="jury-button-prev"]');
var swiperJury = exports.swiperJury = new _swiper.default(swiper, {
  navigation: {
    nextEl: buttonNext,
    prevEl: buttonPrev
  },
...
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var swiper = document.querySelector('[data-swiper="reviews-swiper"]');
var buttonNext = document.querySelector('[data-button="reviews-button-next"]');
var buttonPrev = document.querySelector('[data-button="reviews-button-prev"]');
var swiperJury = exports.swiperJury = new _swiper.default(swiper, {
  navigation: {
    nextEl: buttonNext,
    prevEl: buttonPrev
...
var playVideo = exports.playVideo = function playVideo() {
  var playBtn = document.querySelector('.about__preview-button');
  if (playBtn) {
    playBtn.addEventListener('click', function () {
      var preview = document.querySelector('.about__video-preview');
      if (preview) {
        preview.style.display = 'none';
      }
      var videoIframe = document.querySelector('.about__video-source');
      var src = videoIframe.src;
      videoIframe.src = src.includes('?') ? "".concat(src, "&autoplay=1") : "".concat(src, "?autoplay=1");
...
var _accordions = require("../../vendor/accordion/accordions");
...
},{"../../vendor/accordion/accordions":15}],17:[function(require,module,exports){
...
var _tabs = require("../../vendor/tabs/tabs.js");
var tabs;
...
},{"../../vendor/tabs/tabs.js":19}],19:[function(require,module,exports){
"use strict";
